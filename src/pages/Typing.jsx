...
const Typing = () => {
  ...
  const chatUser = userMap[chatUserKey]?.name || "ADMIN";
  const chatAvatar = userMap[chatUserKey]?.avatar || Adalline;
  ...
  return (
    <div className="flex flex-col items-center pb-20 mt-[5px] px-3">
      {/* Header */}
      <div className="w-[375px]">
        <div className="flex mr-[10px] items-center p-4 justify-between h-[72px]">
          <img
            src={Arrow}
          ...
          <div className="flex p-1  gap-3 mb-2 rounded-lg w-[343px]">
            ...
            <div className="flex-1 ">
              ...
              <div className="flex items-start justify-between mt-1">
                <p className="text-[12px] leading-[16px] text-gray-600 max-w-[70%]"></p>
                <img
                  src={phone}
              ...
              >
                {editingId === (m._id || m.id) ? (
                  ...
                  <>
                    ...
                    >
                      <span className="text-[10px] text-[#]">{m.time}</span>
                    </div>
                  </>
                )}
