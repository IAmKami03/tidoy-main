...
const userMap = {
  1: { name: "Gilbert Ozora", avatar: Gilbert },
};
...
const TypingGilbert = () => {
  ...
  const chatUser = userMap[chatUserKey]?.name || "Gilbert Ozora";
  const chatAvatar = userMap[chatUserKey]?.avatar || Gilbert;
